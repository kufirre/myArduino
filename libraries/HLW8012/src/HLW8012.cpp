...
void HLW8012::_calculateDefaultMultipliers() {
   ...
   //I have commented out the standard multipliers here to input the ones I got from my calibration
   ...
   // _current_multiplier = 8276.44;
   // _voltage_multiplier = 7651297.00;
   // _power_multiplier = 6451317.50;
   
//    _current_multiplier = 9134.66;
//    _voltage_multiplier = 7482020.50;
//    _power_multiplier = 7168131.00;

    _current_multiplier = 8734.63;
    _voltage_multiplier = 7548527.00;
    _power_multiplier = 6936901.00;
